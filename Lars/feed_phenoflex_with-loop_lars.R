...
# Load the csv 
Bonn_forecast_2025_Jan_May <- read.csv("Bonn_forecast_2025_Jan_May.csv")
...
for(i in unique(Bonn_forecast_2025_Jan_May$model)){
  # Extract the first model of the forecast data
  data_forecast <- Bonn_forecast_2025_Jan_May[Bonn_forecast_2025_Jan_May$model == i, ]
  ...
  #save it as list
  weather_combined[[i]] <-phenoflex_2025
